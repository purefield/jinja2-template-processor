...
- apiVersion: hive.openshift.io/v1
  ...
  spec:
    releaseImage: {{ releaseBase }}/openshift-release-dev/ocp-release{% if cluster.releaseDigest is defined %}@{{ cluster.releaseDigest }}{% else %}:{{ cluster.version }}-{{ imageArch }}{% endif %}
