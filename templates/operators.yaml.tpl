...
{%- if (cluster | default({})).get('corePassword') %}{% include "includes/core-user-password.yaml.tpl" %}{% endif -%}
{%- if cluster.platform == "baremetal" and "nmstate" not in ops %}{% include "operators/nmstate/manifests.yaml.tpl" %}{% endif -%}
